...
-- People
  insert into characters(name,birth_year,gender,height,mass,eye_color,hair_color,skin_color) values ('Luke Skywalker','19BBY','Male','1.72 m','77 Kg','Blue','Blond','Caucasian')
  insert into characters(name,birth_year,gender,height,mass,eye_color,hair_color,skin_color) values ('R2-D2','112BBY','n/a','167','75','yellow','n/a','gold')
  insert into characters(name,birth_year,gender,height,mass,eye_color,hair_color,skin_color) values ('C-3PO','33BBY','n/a','96','32','red','n/a','white, blue')
  insert into characters(name,birth_year,gender,height,mass,eye_color,hair_color,skin_color) values ('Darth Vader','41.9BBY','male','202','136','red','none', 'white')
